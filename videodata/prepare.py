...
# for videoPath in os.listdir(path+"Video_Train_Set"):
#
#     # path names
#     txtPath = videoPath[:-4] + ".txt"
#     absPath = path + "Annotations_Train_Set/" + txtPath
#     absPathVid = path + "Video_Train_Set/" + videoPath
...
#
#             newDir = path + "NewData/Training/" +videoPath[:-4]
#             os.mkdir(newDir)
#             newDir2 = newDir+"/FRAMES"
#             os.mkdir(newDir2)
#
#             print("filling " + newDir2 + " with " + str(len(frames)) + "...")
#
#             count = 1
#             for frame in frames:
